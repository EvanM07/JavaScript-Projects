...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // we are saying that if the display_value does not contain a decimal pont
...
function Handle_Operator (Next_Operator) {
    ...
    // checks if an operator already exists and it wait_second_operand is true,
...
// this function updates the screen with the contents of the display_value
